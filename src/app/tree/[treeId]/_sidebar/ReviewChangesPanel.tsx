            ...
            <div className="mt-3 grid gap-2 sm:grid-cols-2">
              {(["device", "server"] as const).map((side) => (
                <button
                  ...
                  onClick={() => resolveBlockedOperation(change.id, side)}
                  className="relative rounded-xl bg-slate-50 p-3 text-left ring-1 ring-slate-200 transition-colors hover:bg-cobalt-50 hover:ring-cobalt-400 active:bg-cobalt-100 disabled:cursor-not-allowed disabled:opacity-50"
                >
